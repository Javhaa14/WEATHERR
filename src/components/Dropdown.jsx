export const Dropdown = ({ className }) => {
  return (
    <div
      className={`flex flex-row mt-[90px] py-4 px-6 min-w-[567px] h-fit bg-[#ffffffcc] rounded-[24px] absolute z-50 backdrop-blur-md gap-4 ${className}`}>
      <svg
      ...
      <p className="overflow-hidden text-black text-ellipsis text-[28px] font-[700]">
        Tokyo, Japan
      </p>
    </div>
  );
